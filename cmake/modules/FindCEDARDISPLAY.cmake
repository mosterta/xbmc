...
find_path(CEDARDISPLAY_INCLUDE_DIR libcedarDisplay.h
	HINTS ${PC_CEDARDISPLAY_INCLUDEDIR} NO_CACHE)

find_library(CEDARDISPLAY_LIBRARY NAMES CEDARDISPLAY cedarDisplay
	HINTS ${PC_CEDARDISPLAY_LIBDIR} NO_CACHE)
...
if(CEDARDISPLAY_FOUND)
  ...
  set(CEDARDISPLAY_DEFINITIONS -DHAVE_LIBCEDARDISPLAY=1 -DUSE_ALLWINNER_DISP=1 -DALLWINNERA10 -DUSE_VIDEO_SYNC_FB)
