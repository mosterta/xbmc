...
find_path(VDPAU_SUNXI_INCLUDE_DIR NAMES vdpau/vdpau.h
                          PATHS ${PC_VDPAU_SUNXI_INCLUDEDIR})

find_library(VDPAU_SUNXI_LIBRARY NAMES vdpau_sunxi
	HINTS ${PC_VDPAU_SUNXI_LIBDIR} NO_CACHE)
...
if(VDPAU_SUNXI_FOUND)
  ...
  if(NOT TARGET VDPAU_SUNXI::VDPAU_SUNXI)
    ...
    set_target_properties(VDPAU_SUNXI::VDPAU_SUNXI PROPERTIES
			   ...
			   #set_property(GLOBAL APPEND PROPERTY INTERNAL_DEPS_PROP VDPAU_SUNXI::VDPAU_SUNXI)
  endif()
endif()
